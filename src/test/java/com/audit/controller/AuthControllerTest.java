...
import com.audit.controller.AuthController;
...
public class AuthControllerTest {
	...
	public void generateJwtTest() {
		...
		projectManagerDetails = new ProjectManagerDetails(1, "name1", "user1", "abcd1234", "Project1","AppOwner1");
	...
	public void validateJwt() {
		...
		authenticationResponse = new AuthenticationResponse("name1", "Project1","AppOwner1", true);
		...
		// now for wrong
		jwtTokenHeader = "Bearer ";
		// making ProjectManagerDetails
		projectManagerDetails = null;
		// making authentication-response
		authenticationResponse = new AuthenticationResponse("Invalid", "Invalid","Invalid", false);
		username = "";
		// first remove Bearer from Header
